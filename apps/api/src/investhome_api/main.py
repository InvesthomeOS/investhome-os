...
from investhome_api.api.routes import activity, auth, company_foundation, crm, crm_activities, crm_agreements, crm_bitrix, crm_contacts, crm_relationships, crm_reports, design_studio, document_intelligence, documents, drawing_intelligence, executive, finance, health, inventory, inventory_assignment, inventory_ownership, inventory_pricing, inventory_reservations, investors, lead_qualification, leads, meta, notifications, projects, roles, sales_inventory_matching, sales_opportunities, sales_proposals, sales_readiness, search, users, work_items
